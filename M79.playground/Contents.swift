...
* mobile device.
* Progam your own shader function in `khyberPass` in BleedingMadras.metal. You
...
do {
  let path = Bundle.main.path(forResource: "BleedingMadras", ofType: "metal")
...
renderer.functionName = "khyberPass"
